...
import org.grails.samples.Veterinarian
...
class BootStrap {
	...
	def init = { servletContext ->
		if (!Speciality.count()) {
			...
			new Veterinarian(firstName: 'James', lastName: 'Carter').save(failOnError: true)
			new Veterinarian(firstName: 'Helen', lastName: 'Leary')
					.addToSpecialities(radiology)
					.save(failOnError: true)
			new Veterinarian(firstName: 'Linda', lastName: 'Douglas')
					.addToSpecialities(surgery)
					.addToSpecialities(dentistry)
					.save(failOnError: true)
			new Veterinarian(firstName: 'Rafael', lastName: 'Ortega')
					.addToSpecialities(surgery)
					.save(failOnError: true)
			new Veterinarian(firstName: 'Henry', lastName: 'Stevens')
					.addToSpecialities(radiology)
					.save(failOnError: true)
			new Veterinarian(firstName: 'Sharon', lastName: 'Jenkins').save(failOnError: true)
